    ...
    <div style={{minHeight:'100vh',background:'#f0f4f8'}}>
      <nav style={{background:'#0d3b5e',padding:'0 20px',display:'flex',alignItems:'center',gap:2,position:'sticky',top:0,zIndex:100,boxShadow:'0 2px 12px rgba(13,59,94,0.4)',borderBottom:'2px solid #c8264a'}}>
        <div style={{display:'flex',alignItems:'center',marginRight:16,padding:'8px 0'}}>
          {logoUrl
            ?<img src={logoUrl} alt="Matilda" style={{height:52,objectFit:'contain'}}/>
            :<div style={{color:'#fff',fontSize:22,fontStyle:'italic',fontWeight:900,letterSpacing:1}}>matilda <span style={{fontSize:10,color:'#3dbfb8',letterSpacing:2,fontStyle:'normal',fontWeight:600}}>EVENT DESIGNERS</span></div>}
        </div>
        {TABS.map(([k,l])=>(
